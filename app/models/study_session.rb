...
class StudySession < ActiveRecord::Base
  ...
  attr_accessor :remote_addr, :buddy_ids, :message, :sender_id
  ...
  def associate_users
    ...
    @buddy_ids.uniq.reject(&:blank?).each do |buddy_id|
      ...
      subject = "#{invitee.first_name.titleize}, you have been invited to a study session!"   

      sender.send_message?(subject, message, invitee)   
  ...
  def send_invite(invitee)
    Notifier.study_session_invite(user, invitee, self).deliver
  end
